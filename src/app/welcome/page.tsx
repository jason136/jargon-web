...
export default function WelcomePage() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <h3 className="font-quicksand py-5 text-center text-[15px] font-semibold text-zinc-500">
        Click confirm to get your account all set up!
      </h3>

      <video
        className="h-[282px] w-[230px]"
        width="230"
        height="282"
        loop
        playsInline
      ...
      <button className="mt-4 flex items-center justify-center rounded-[20px] bg-indigo-400">
