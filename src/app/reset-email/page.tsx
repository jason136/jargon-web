...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      {error && (
        <div className="font-quicksand my-2 text-center text-neutral-700">
          This email isn&apos;t registered with us, please try again.
        </div>
      )}
      {waitMessage && (
        <div className="font-quicksand my-2 text-center text-neutral-700">
          You should shortly receive an email to reset your password. Be sure to
          check your spam folder, or contact us for help if you haven&apos;t!
        </div>
      )}
    </div>
  );
